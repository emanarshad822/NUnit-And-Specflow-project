...
namespace amazonProjectBDD.Features
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Amazon Shopping", "    As an unregistered user\r\n    I want to search for a specific item\r\n    And ad" +
                    "d it to the cart\r\n    So that I can validate the correct item and amount in the " +
                    "cart", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 12
    testRunner.Then("I validate the correct item and amount is displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
